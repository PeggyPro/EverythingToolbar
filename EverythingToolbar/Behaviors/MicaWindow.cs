...
namespace EverythingToolbar.Behaviors
{
    ...
    {
        public static readonly DependencyProperty MicaWindowStyleProperty = DependencyProperty.Register(
            nameof(MicaWindowStyle),
            typeof(MicaWindowStyleType),
            typeof(MicaWindow),
            new FrameworkPropertyMetadata(MicaWindowStyleType.MainWindow)
        );
